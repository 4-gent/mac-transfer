...
char appName2[256]; //Second word for app name
char appName3[256]; //Third word for app name
...
int multName = 0; //Variable for opening applications with multiple names
...
if(!strcmp(options, "a") || !strcmp(options, "A")){
    ...
    //Adding user to primary group ID 20
    std::string primeGrouppt1("-create /Users/");
    std::string primeGrouppt2(" PrimaryGroupID 20");
    ...
    std::string homeDirpt2(" NFSHomeDirectory /Local/Users/");
